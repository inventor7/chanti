<template>
    <SignupLayout prevLink="field" :pageNumber="pNumber" 
        :isError="notSelectedError" errorText="Please select at least one service" nextBtnText="Next" @handle="handleClick"
