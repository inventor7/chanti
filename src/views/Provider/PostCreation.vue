<template>
    <ProviderLayout>
        ...
        <div class="w-full h-full flex flex-col items-center bg-white rounded-xl gap-2 p-3">
        ...
        <ProviderPosts />
        <Alert closeBtnText="Post" @handleCloseBtn="SendPost" closeBtnColor="primary" toggleBtnText="Create Post">
