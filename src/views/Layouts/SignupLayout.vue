    ...
    <div class=" h-screen " :data-theme="themeStore.$state.theme">
        <div class=" md:flex md:flex-col md:justify-center md:items-center    md:py-6 max-h-screen  h-full w-full ">
            <div
                ...
                <div class="flex flex-col  w-full bg-primary relative md:rounded-t-2xl gap-1 sm:gap-2  px-3 py-1 ">
                    <div :class="{ 'text-end ': languageStore.getRtl }" class="w-full  ">
                    ...
                    <div :class="{ ' left-2 ': languageStore.getRtl, 'right-2 ': !languageStore.getRtl }"
                        class="absolute  top-1   block  text-white text-xl sm:text-base  ">
