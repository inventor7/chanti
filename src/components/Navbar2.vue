<template>
    <div dir="ltr" class="navbar border-b-2 -xl mb-8 fixed  top-0  fd  py-0 bg-base-100  z-50 " ref="navbar">
        <div class="navbar-start pl-2 ">
            <button @click="handleGetNotification" class="btn btn-ghost btn-circle">
                <div class="indicator">
                    ...
                    <span class="badge p-2  badge-xs badge-primary indicator-item"
                    :class="notificationStore.$state.notificationsNumber ? 'badge-secondary animate-pulse ' : 'badge-primary '"
                    >
